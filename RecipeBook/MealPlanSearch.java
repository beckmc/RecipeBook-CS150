...
public class MealPlanSearch {
    ...
    private int previousTotalTime = 0;
     ...
     */
    public MealPlanSearch(RecipeBook rb) {
        this.rb = rb;
    }
    ...
    private ArrayList<Recipe> iterateTree() {
        ...
        while (iterator.hasNext()) {
            ...
            if (next.getTotalTime() == previousTotalTime) {
                canAdd = false;
            } else {
                previousTotalTime = next.getTotalTime();
            }
            
            if (!type.equals("all")) {
                if (type.equals("Entree") && !next.getType().equals("Entree")) {
                    canAdd = false;
                }
                if (type.equals("Salad") && !next.getType().equals("Salad")) {
                    canAdd = false;
                }
                if (type.equals("Appetizer") && !next.getType().equals("Appetizer")) {
                    canAdd = false;
                }
            }
     ...
     * 
     * @param totalTime The highest time the meal plan can take.
     ...
     */
    public ArrayList<Recipe> search(int totalTime, String includedItems, String excludedItems, String cuisine, String type) {
